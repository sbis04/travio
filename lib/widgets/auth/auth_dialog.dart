...
class _AuthContentState extends State<AuthContent> {
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        logPrint(
            '✅ Google Sign-In successful${widget.isDialog ? ', closing dialog' : ''}');
      } else {
        logPrint(
  ...
  @override
  Widget build(BuildContext context) {
    final googleAuthButton = InkWell(
    ...
    final emailAuthForm = Form(
      ...
      child: Column(
        children: [
          ...
          // TODO: Fix the forgot password flow
    ...
    final authContent = widget.isDialog
        ? Flexible(
        ...
        : Row(
            children: [
              Expanded(child: emailAuthForm),

              const SizedBox(width: 24),
              // Divider with "OR"
              SizedBox(
                height: _currentMode == AuthMode.signIn ? 260 : 347,
                child: Column(
                  children: [
                    Expanded(
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.symmetric(
            horizontal: widget.isDialog ? 24 : 0,
            vertical: 16,
          ),
          child: Row(
            children: [
